  ...
  return (
    <div className="min-h-dvh bg-white page-enter flex flex-col">
      ...
      <div className="flex-1 px-5 py-5 overflow-y-auto space-y-5">
        ...
        {/* Pricing — Photography is event-based only; everything else a single price */}
        {category === 'Photography' ? (
          <div>
            <label className="text-[11px] font-medium text-dark block mb-1">How do you price?</label>
            <p className="text-[10px] text-gray-400 mb-2">Create a pricing card per event group, pick the events it covers, and set a flat price per service.</p>
          ...
          <div>
            <label className="text-[11px] font-medium text-dark block mb-1">Create your pricing cards</label>
            <p className="text-[10px] text-gray-400 mb-2">Add a card per event — pick the event, set the number of artists, hours, and a flat price. Add as many events as you perform at.</p>
