...
import { expandEventPackageListings, expandEntertainerListings, expandBanjantriluListings } from '@/lib/store'
...
export default function SharedBoardPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      // Expand Photography event packages / Entertainer rates / Banjantrilu cards so a shared board's picks resolve.
      const mapped: ListingLite[] = expandBanjantriluListings(expandEntertainerListings(expandEventPackageListings(allListings as Record<string, unknown>[]))).map((l, i) => {
