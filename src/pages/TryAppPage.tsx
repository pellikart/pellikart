      ...
      <section className="pt-28 pb-12 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { title: 'Visual mood boards', body: 'Pinterest-style ritual boards for every event. Engagement, Pelli, Reception, Sangeeth — each with its own dates, vendors, and budget.' },
