        ...
        {addableCount > 0 && (
          <div className="relative rounded-xl overflow-hidden min-h-[90px] md:min-h-[200px]">
            <button
              ...
              className="w-full h-full min-h-[90px] md:min-h-[200px] bg-empty-bg flex flex-col items-center justify-center gap-1 cursor-pointer active:bg-gray-200 transition-colors rounded-xl"
            >
